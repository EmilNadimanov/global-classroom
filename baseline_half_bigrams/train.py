...
print(half_bigram_counts['43'])
print(half_bigrams['43'])
print(half_bigrams['0'])
print(bigram_counts['43'])
print(bigrams['43'])

#print(half_bigrams)
print('Written %d unigrams, %d half-bigrams and %d bigrams to %s.' % (len(unigrams.keys()), n_half_bigrams, n_bigrams, model_file))
